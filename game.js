...
function moveBear(e) {
    ...
    if (e.keyCode == KEYDOWN) { bear.move(0, 1)} // down key
}
...
function overlap(element1, element2) {
    ...
    left1 = element1.htmlElement.offsetLeft;top1 = element1.htmlElement.offsetTop;
